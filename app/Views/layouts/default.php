...
<head>
    ...
    <meta property="og:image" content="<?= esc($ogImage ?? base_url('images/default-og-image.jpg')) ?>">
    ...
    <meta name="twitter:image" content="<?= esc($twitterImage ?? base_url('images/default-twitter-image.jpg')) ?>">
